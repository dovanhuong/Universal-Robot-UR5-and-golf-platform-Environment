...
def move1():
    ...
    try:
        ...
        client_ursim.send_goal(g)
        client_ursim.wait_for_result()
    except KeyboardInterrupt:
        client_ursim.cancel_goal()
        raise
    except:
        raise
...
def main():
    ...
    try:
        ...
        client_ursim = actionlib.SimpleActionClient('/vel_based_pos_traj_controller/follow_joint_trajectory',
                                                    FollowJointTrajectoryAction)
        print("Waiting for ursim server...")
        client_ursim.wait_for_server()
        print("Connected to ursim server")
